...
export { PromptInputWithActions as PromptInput } from '@/components/prompt-input'
export { PromptInputCollapsed } from '@/components/prompt-input-collapsed'
export { PromptInputExpanded } from '@/components/prompt-input-expanded'
