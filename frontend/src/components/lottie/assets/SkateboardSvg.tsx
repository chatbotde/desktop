...
export const SkateboardSvg: React.FC<SvgProps> = (props) => {
    return (
        <div className="skater-asset-wrapper" style={{ width: '100%', height: '100%' }}>
            <style>
                {`
                .skater-svg {
                    width: 100%;
            ...
            <svg viewBox="400 200 250 400" className="skater-svg" xmlns="http://www.w3.org/2000/svg" {...props}>
                <defs>
                ...
                <g style={{ stroke: '#FFFFFF', strokeWidth: '1px', strokeLinejoin: 'round' }}>
