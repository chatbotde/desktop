...
export interface RollsRoyceSvgProps extends SvgProps {
    isTalking?: boolean;
    isSmiling?: boolean;
}

export const RollsRoyceSvg: React.FC<RollsRoyceSvgProps> = ({
    width = "100%",
    height = "auto",
    isTalking = true,
    isSmiling = false,
    ...
    return (
        <div className="rr-asset-wrapper" style={{ width, height }}>
            <style>
                {`
                .rr-svg {
                    width: 100%;
            ...
            <svg className="rr-svg" viewBox="0 0 1000 450" xmlns="http://www.w3.org/2000/svg" {...props}>
                <defs>
                ...
                <g>
                    ...
                    {/* Speed Lines */}
                    <g className="rr-speed-lines">
                        <line x1="1000" y1="120" x2="1200" y2="120" className="rr-line-1" />
                        <line x1="1030" y1="150" x2="1230" y2="150" className="rr-line-2" />
                        <line x1="990" y1="280" x2="1190" y2="280" className="rr-line-3" />
                        <line x1="1020" y1="310" x2="1220" y2="310" className="rr-line-4" />
                    </g>
                </g>
            </svg>
        </div>
