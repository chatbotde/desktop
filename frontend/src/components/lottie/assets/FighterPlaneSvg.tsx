...
export const FighterPlaneSvg: React.FC<SvgProps> = (props) => {
    return (
        <div className="fighterplane-asset-wrapper" style={{ width: '100%', height: '100%' }}>
            ...
            <svg viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" className="fighterplane-svg" xmlns="http://www.w3.org/2000/svg" {...props}>
                <defs>
